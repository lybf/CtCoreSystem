...
//万向桥
public class CTPhaseNode extends ItemBridge {
    public DrawBlock drawer = new DrawMulti(new DrawDefault(), new CtCoreSystem.CoreSystem.draw.DrawPhaseNode());

    public CTPhaseNode(String name) {
        super(name);
        // 启用交换对角线放置的规则
    ...
    public boolean linkValid(Tile tile, Tile other, boolean checkDouble) {
        ...
        return ((other.block() == tile.block() && tile.block() == this) || (!(tile.block() instanceof CTPhaseNode) && other.block() == this))

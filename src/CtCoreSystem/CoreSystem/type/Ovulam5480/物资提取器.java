...
public class 物资提取器 extends Block {
    public float range = 20f;
    public 物资提取器(String name) {
        super(name);
        hasItems = true;
        itemCapacity = 30;
        destructible = true;
        ...
        config(Integer.class, (物资提取器Building entity, Integer value) -> {
        ...
        config(Point2[].class, (物资提取器Building tile, Point2[] value) -> {
    ...
    public class 物资提取器Building extends Building {

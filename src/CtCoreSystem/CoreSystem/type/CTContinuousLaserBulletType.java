...
public class CTContinuousLaserBulletType extends ContinuousBulletType {
    ...
    public CTContinuousLaserBulletType(float damage) {
        this.damage = damage;
    }

    public CTContinuousLaserBulletType() {
    }

    ...
    public class LaserMassDriverBuilding extends MassDriverBuild {
        ...
        public void updateTile() {
            ...
            if (t != timer) {
                ...
                Vec2 vec22 = new Vec2(link.x - offX, link.y - offY);
                Vec2 vec222 = new Vec2(link.x + offX2, link.y + offY2);
                Vec2 vec2222 = new Vec2(link.x - offX2, link.y - offY2);

                Fx.chainLightning.at(x + offX, y + offY, rotation, Color.pink, vec2);
                Fx.chainLightning.at(x - offX, y - offY, rotation, Color.pink, vec22);
                Fx.chainLightning.at(x + offX2, y + offY2, rotation, Color.pink, vec222);
                Fx.chainLightning.at(x - offX2, y - offY2, rotation, Color.pink, vec2222);
            }

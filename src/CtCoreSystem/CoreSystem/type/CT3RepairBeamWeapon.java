...
/*修理光束武器*/
public class CT3RepairBeamWeapon extends RepairBeamWeapon {
    ...
    public CT3RepairBeamWeapon(String name) {
        super(name);
    ...
    public void update(Unit unit, WeaponMount mount) {
        ...
        if (heal.target instanceof Building && mount.shoot) {
            ...
            CT3RepairBeamWeapon.unit = unit;
            CT3RepairBeamWeapon.BlockRange = range;
            CT3RepairBeamWeapon.building = b;

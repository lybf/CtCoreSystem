package CtCoreSystem.CoreSystem.draw;
...
public class DrawPhaseNode extends DrawBlock {
    ...
    public void draw(Building build) {
        if(!(build instanceof CtCoreSystem.CoreSystem.type.guiY.PhaseNode.PhaseNodeBuild)) return;
        drawR((CtCoreSystem.CoreSystem.type.guiY.PhaseNode.PhaseNodeBuild) build);
    }
    public void drawR(CtCoreSystem.CoreSystem.type.guiY.PhaseNode.PhaseNodeBuild build){
        Draw.z(Layer.power);

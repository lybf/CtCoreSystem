...
public enum CTDifficulty{
    ...
    public static final CTDifficulty[] all = values();

    //TODO add more fields
    public float enemyHealthMultiplier, enemySpawnMultiplier, waveTimeMultiplier;

    CTDifficulty(float enemyHealthMultiplier, float enemySpawnMultiplier, float waveTimeMultiplier){
